...
WP_PLUGIN_DIR="/var/www/localhost/wp/wp-content/plugins/obsession"
# You can also use the deploy.sh script to deploy to multiple WordPress installations, using:
	...
	#WP_PLUGIN_DIR=(
	#	"/var/www/localhost/wp1/wp-content/plugins/obsession"
	#	"/var/www/localhost/wp2/wp-content/plugins/obsession"
	#)
EOF

echo 'Please modify the "config.sh" file and enter your local settings.'
echo 'Then use "sleek-share/deploy.sh" script to deploy the plugin.'
